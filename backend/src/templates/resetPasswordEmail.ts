export const resetPasswordEmailHtml = (otp: string): string => `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Reset your Soundrift password</title>
</head>
    ...
    <tr>
      <td align="center" style="padding:48px 16px">
        <table width="480" cellpadding="0" cellspacing="0" role="presentation" style="max-width:480px;width:100%;background:linear-gradient(165deg,#1a1c23 0%,#101218 100%);border-radius:28px;border:1px solid rgba(255,255,255,0.08);padding:48px 36px;box-shadow:0 30px 60px rgba(0,0,0,0.6)">
          ...
          <tr>
            <td align="center" style="padding-bottom:8px">
              <p style="color:#e5e7eb;font-size:16px;margin:0 0 4px;line-height:1.6">Reset your password</p>
              <p style="color:#9ca3af;font-size:14px;margin:0 0 24px;line-height:1.5">Use the code below to reset your password. This code is valid for 10 minutes.</p>
            </td>
          </tr>
          ...
          <tr>
            <td align="center">
              ...
              <p style="color:#f87171;font-size:12px;margin:16px 0 0;line-height:1.5">If you didn't request this, please ignore this email.<br>Your password will remain unchanged.</p>
            </td>
          </tr>
          ...
          <tr>
            <td align="center" style="padding-top:32px">
              ...
              <p style="color:#6b7280;font-size:11px;margin:0;letter-spacing:0.5px">SOUNDRIFT &bull; WHERE MUSIC FINDS YOU</p>
            </td>
          </tr>
        </table>
      </td>
